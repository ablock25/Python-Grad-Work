##Write a function birthState() that takes as input
##the full name of a recent U.S. president (as a string)
##and returns his birth state.
...
def birthState(President):
    "Returns the entered president's birth state."
    ...
    return president_dict[President]
